...
BuildTemp(lt_id, t_n, t_id, r, 1, concat(s, IRISafe(x), s1)) :- Mapping(tm, z, tr_id), lt(t_n, r, c1, x), Mapping(tr_id, "rr:template", t_id), Temp(t_id, 1, c1, s1), Temp0(t_id, m, s), Mapping(tm, "rr:logicalTable", lt_id), Mapping(lt_id,"rr:tableName",t_n). 
BuildTemp(lt_id, t_n, t_id, r, i, concat(z, IRISafe(x), si)) :- Temp(t_id, i, ci, si), lt(t_n, r, ci, x), BuildTemp(lt_id, t_n, t_id, r, i-1, z). 
EvalTemp(lt_id, t_id, r, x) :- Temp0(t_id, m, s), BuildTemp(lt_id, t_n, t_id, r, m, x).
Bl(sm_id) :- Mapping(sm_id, "rr:termType", "rr:BlankNode").
Subject(x, tm, sm_id, concat("<",y,">")) :- Mapping(tm, "rr:subjectMap", sm_id), ~Bl(sm_id), Termval(x, tm, sm_id, y).
Subject(x, tm, sm_id, concat("_:",y)) :- Mapping(tm, "rr:subjectMap", sm_id), Mapping(sm_id, "rr:termType", "rr:BlankNode"), Termval(x, tm, sm_id, y).
Predicate(x, tm, pom_id, concat("<",y,">")) :- Termval(x, tm, pm_id, y), Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:predicateMap", pm_id).
...
Object(x, tm, pom_id, concat("<",y,">")) :- Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:objectMap", om_id), Termval(x, tm, om_id, y), Mapping(om_id, "rr:termType", "rr:IRI").
Object(x, tm, pom_id, concat("<",y,">")) :- Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:objectMap", om_id), ~Datatype(om_id), ~Lantag(om_id), ~Column(om_id), Termval(x, tm, om_id, y).
Object(x, tm, pom_id, concat("_:",y)) :- Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:objectMap", om_id), Termval(x, tm, om_id, y), Mapping(om_id, "rr:termType", "rr:BlankNode").
...
Object(x, tm, pom_id, concat(y,"^^",dm)) :- Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:objectMap", om_id), Termval(x, tm, om_id, y), Mapping(om_id, "rr:datatype", dm).
Object(x, tm, pom_id, concat(y,"@",lm)) :- Mapping(tm, "rr:predicateObjectMap", pom_id), Mapping(pom_id, "rr:objectMap", om_id), Termval(x, tm, om_id, y), Mapping(om_id, "rr:language", lm).
...
Graph(x, tm, tr_id, concat("<",y,">")) :- Mapping(tr_id, "rr:graphMap", gm_id), Termval(x, tm, gm_id, y).
